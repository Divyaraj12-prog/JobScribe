  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-700/60">
        <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-linear-to-br from-indigo-500 to-indigo-600 shadow-lg shadow-indigo-500/30">
        ...
        <span className="text-lg font-bold tracking-tight text-white">JobScribe</span>
      ...
      <div className="px-3 py-4 border-t border-slate-700/60">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-red-400 transition-all duration-150 group"
        >
          <span className="shrink-0 transition-transform duration-150 group-hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
