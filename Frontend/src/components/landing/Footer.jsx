  ...
  <footer className="bg-slate-900 text-slate-400 pt-16 pb-8">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
        ...
        <div className="lg:col-span-2">
          <Link to="/" className="flex items-center gap-2.5 mb-4 w-fit">
            ...
            <span className="text-lg font-bold text-white tracking-tight">JobScribe</span>
          </Link>
          <p className="text-sm leading-relaxed text-slate-500 max-w-xs mb-6">
            The AI-powered job application tracker that helps you land more interviews and stay organized throughout your search.
          </p>
          {/* Socials */}
        ...
        {Object.entries(footerLinks).map(([column, links]) => (
          <div key={column}>
            <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4">{column}</h4>
      ...
      <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-600">
        <p>© {new Date().getFullYear()} JobScribe. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
